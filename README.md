...
This is an Android library which can be used with an application to integrate input from a [Contour design Shuttle Xpress](https://contour-design.co.uk/product/shuttlexpress/).

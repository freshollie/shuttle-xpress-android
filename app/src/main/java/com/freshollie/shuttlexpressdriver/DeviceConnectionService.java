...
public class DeviceConnectionService extends Service {
    public static String TAG = DeviceConnectionService.class.getSimpleName();
    private static int NOTIFICATION_ID = 0;

    private static final String ACTION_USB_PERMISSION =
            "com.freshollie.shuttlexpressdriver.action.USB_PERMISSION";
    ...
    public void openConnection() {
        ...
        if (usbDevice != null) {
            ...
            shuttleXpressDevice = ShuttleXpressDevice.getInstance();
    ...
    public void runListeningThread() {
